...
def extract_article_info(html_file_path, search_lists=search_lists):
    ...
    if body_tag is None:
        ...
        if len(search_lists[1])>0:
            ...
            title_long = title
        content = search_content(soup, search_lists[2])
